  ...
  return (
    <div className={styles.math_in_the_pandemic}>
      ...
      <p className={styles.text}>
        ...
        before. In fact, according to the Portland-based non-profit NWEA, in the
        fall of 2020 elementary and middle school students were scoring 5-10%
        lower on mathematics tests than in 2019. In the same study it was shown
        that students did not see the same decrease in other subjects, such as
        reading.
      </p>
      <p className={styles.text}>
        ...
        reading and writing are relatively easy subjects to teach when compared
        to math.
      </p>
      <p className={styles.text}>
        While it may be too early to definitively say that the pandemic has led
        to a loss of mathematical skill in school students, this shouldn’t
        really come as much of a surprise to anyone. After all, students rely on
        being able to ask their teachers for help, being able to work on problem
      ...
      <p className={styles.text}>
        ...
        problem. This is a complex situation with very few clear solutions. An
        example of the difficulty that comes with showing exactly how much has
        been lost by students is perhaps best given by the fact that these
        statistics were only generated from the data of those students who took
        their mathematics tests. Some students, particularly from minority
        groups, are disproportionately underrepresented in the study. At the
        very least, the statistics are skewed higher than accurate.
      </p>
      <p className={styles.text}>
        Aside from the fact that students are simply getting less and lower
        quality instruction due to online learning, there is also the difficulty
        of heightened rates of depression and anxiety brought on by the
        pandemic. A large number of students are attending class less, doing
        less of their homework, and paying less attention to the classes they do
        attend. This is a problem we can likely expect to gradually dissipate as
        we all return to the classroom.
      </p>
      <p className={styles.text}>
      ...
      <p className={styles.text}>
        ...
        explain the general lack of attentiveness of students who are currently
        distance learning.
      </p>
      <p className={styles.text}>
        ...
        that without the classroom setting we can’t uniformly rely on parents to
        do the teacher’s job. Parents are continuing to work their normal day
        jobs as well. They now have to both work full time while also being
        responsible for making sure their children are taking their education
        seriously.
      </p>
      <p className={styles.text}>
        There are other challenges that come with trying to determine the effect
        this pandemic has had on mathematics education. For one, because schools
        are so used to doing testing in-person, the technological difficulties
        of distance-testing has led some schools to simply stop testing
        altogether. While this might seem like a good idea for now, as it
        decreases the strain teachers, students, and administrators are under,
        long-term it may prove a serious problem. We may all be in for a major
      ...
      <p className={styles.text}>
        ...
        were able to conduct testing when compared to public schools. This would
        make sense, given that private schools tend to be smaller and have more
        resources available to devote to each student. They can both make sure
        their students are healthy and safe while also offering them one-on-one
        help, and are more readily able to test given their resources. This all
        makes the situation with scores even more tenuous and unreliable.
      </p>
      <p className={styles.text}>
        What is clear out of all of this is the fact that we just don’t know how
        students will have dealt with this pandemic until at least several
        months from now. Once everyone is back in school, vaccinated, and taking
        tests again, it may be clear how harmful this period was for everyone
        academically. Until then, it’s safe to say that the education of our
        students will have suffered, if only to an indeterminate degree.
      </p>
