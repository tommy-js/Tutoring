  ...
  return (
    <div className={styles.the_role_tutoring_will_play}>
      ...
      <p className={styles.text}>
        Perhaps the most interesting effect the pandemic has had has to do with
        the economic landscape. Certain industries, such as hospitality and
        physical services, have suffered over the past year. Others, such as the
        online technology sectors, have never done better. To note this, all you
      ...
      <p className={styles.text}>
        ...
        learning has been to greatly increase demand for online one-on-one
      ...
      <p className={styles.text}>
        ...
        the school year, and so there’s good reason to believe that by the fall
        we’ll all be back in classrooms going about our education normally.
      </p>
      ...
      <p className={styles.text}>
        ...
        business in the future, we can look to how it’s doing right now and make
        some inferences. In 2020 alone, 1.4 billion students across the world
        were impacted by the pandemic. These were children and young adults out
        of school, home from college, and trying to cope with online learning.
        Their teachers had to adapt rapidly, and so there was plenty of
        confusion as a result. Students got lost in the process, and they felt
        forced to seek outside help in the form of online and in-person
        tutoring.
      </p>
      <p className={styles.text}>
        There are some good reasons to believe that the future of online
        tutoring is a bright one. Just as the film industry has now had a chance
      ...
      <p className={styles.text}>
        ...
        isn’t nearly as effective as we would have hoped. In this case, however
        unlikely it is, there might be further resistance to online tutoring in
        the future. In either case, parents and teachers will draw conclusions
        about the value of tutoring as a whole for their students.
      </p>
      <p className={styles.text}>
        Still, this is an unlikely result. There is hope that online tutoring is
        here to stay, and will grow in future months and years far beyond where
        it was only a few years ago. The truth is, many parents find the
      ...
      <p className={styles.text}>
        ...
        pandemic. Because our world is becoming more and more globalized,
      ...
      <p className={styles.text}>
        ...
        higher grades is to hire a tutor. Online companies offering this kind of
        service are investing billions of dollars each year into improving the
        skills of their tutors, adding quality content, and doing research to
        better understand the needs of their students.
      </p>
      <p className={styles.text}>
        A common misconception is that it’s only the wealthy private school
        attendees that are seeking online tutoring. Actually, it can be in part
        due to the inadequacy of their public schools that many parents are
        turning to online help. Because internet tutoring is now so affordable,
        it makes sense for many of these parents and their children to go in
        this direction rather than pay tens of thousands per year to attend a
        private school, even when this public school is woefully underfunded and
        understaffed.
      </p>
      <p className={styles.text}>
        You can see that there are many reasons why online tutoring is likely to
        grow in the coming months and years. Now all that remains is to see what
        happens and hope that the end result is good for everyone involved.
      </p>
