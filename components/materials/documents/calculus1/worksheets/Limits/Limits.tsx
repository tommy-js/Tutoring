...
export const Limits: React.FC = () => {
  ...
  const problem_base = [
    ...
    {
      text: "Find the limit of",
      problem: "\\lim_{b \\to \\infty}\\frac{1}{b^2}",
      solution: "\\lim_{b \\to \\infty}\\frac{1}{b^2}=DNE",
      ind: 26,
    },
    {
      text: "Find the limit of",
      problem: "\\lim_{a \\to 0}\\frac{1}{a^3}",
      solution: "\\lim_{a \\to 0}\\frac{1}{a^3}=DNE",
      ind: 27,
    },
    {
      text: "Find the limit of",
      problem: "\\lim_{h \\to 2}\\frac{h^3+5}{h-3}",
      solution: "\\lim_{h \\to 2}\\frac{h^3+5}{h-3}=-13",
      ind: 28,
    },
    {
      text: "Find the limit of",
      problem: "\\lim_{h \\to 0}\\frac{[(h+x)^2-4]-[x^2-4]}{h}",
      solution: "\\lim_{h \\to 0}\\frac{[(h+x)^2-4]-[x^2-4]}{h}=2x",
      ind: 29,
    },
    {
      text: "Find the limit of",
      problem: "\\lim_{a \\to 0}\\frac{[6(x+a)-3]-[6x-3]}{a}",
      solution: "\\lim_{a \\to 0}\\frac{[6(x+a)-3]-[6x-3]}{a}=6",
      ind: 30,
    },
  ];
