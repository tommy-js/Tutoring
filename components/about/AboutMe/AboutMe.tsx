...
import { ClimbingVideo } from "../../front_page/ClimbingVideo/ClimbingVideo";
    ...
    <div className={styles.about_me_container}>
      <div className={styles.about_me}>
        ...
        <p className={styles.text}>
          ...
          close enough to the famous Shawangunks that I could continue taking
          part in one of my major passions: rock climbing. Being out along the
          cliff evokes such a sense of peace and wonder, and I am immensely
          grateful for the hard work of park rangers in upkeeping the rock
          climbing there.
        </p>
        <ClimbingVideo />
        <p className={styles.text}>
        ...
        <p className={styles.text}>
          Apart from climbing, I remain a perpetual student. Currently I'm in
          the process of learning Russian for personal interest. I've always
          found the language to be quite beautiful, and one day I aim to be
          fluent. It would be amazing to spend a few months studying mathematics
          in Russia, although the pandemic will have to end before I consider
        ...
        <p className={styles.text}>
          ...
          started its construction in 1555 and now serves as an historic
          landmark and national symbol of Russia. Just look how beautiful that
          is!
        </p>
        <p className={styles.text}>
